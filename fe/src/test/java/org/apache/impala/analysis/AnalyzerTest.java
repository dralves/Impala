...
public class AnalyzerTest extends FrontendTestBase {
  ...
  private void testSelectStar() throws AnalysisException {
    ...
    Assert.assertEquals(93.0f, tupleDesc.getAvgSerializedSize(), 0.0);
    checkLayoutParams("functional.alltypes.date_string_col", 16, 0, 84, 0, analyzer);
    checkLayoutParams("functional.alltypes.string_col", 16, 16, 84, 1, analyzer);
    checkLayoutParams("functional.alltypes.timestamp_col", 12, 32, 84, 2, analyzer);
    checkLayoutParams("functional.alltypes.bigint_col", 8, 44, 84, 3, analyzer);
    checkLayoutParams("functional.alltypes.double_col", 8, 52, 84, 4, analyzer);
    checkLayoutParams("functional.alltypes.id", 4, 60, 84, 5, analyzer);
    checkLayoutParams("functional.alltypes.int_col", 4, 64, 84, 6, analyzer);
    checkLayoutParams("functional.alltypes.float_col", 4, 68, 84, 7, analyzer);
    checkLayoutParams("functional.alltypes.year", 4, 72, 85, 0, analyzer);
    checkLayoutParams("functional.alltypes.month", 4, 76, 85, 1, analyzer);
    checkLayoutParams("functional.alltypes.smallint_col", 2, 80, 85, 2, analyzer);
    checkLayoutParams("functional.alltypes.bool_col", 1, 82, 85, 3, analyzer);
    checkLayoutParams("functional.alltypes.tinyint_col", 1, 83, 85, 4, analyzer);
  }
  ...
  private void testNonMaterializedSlots() throws AnalysisException {
    ...
    checkLayoutParams("functional.alltypes.date_string_col", 16, 0, 56, 0, analyzer);
    checkLayoutParams("functional.alltypes.timestamp_col", 12, 16, 56, 1, analyzer);
